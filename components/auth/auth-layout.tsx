      ...
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
        <Card className="bg-slate-900/50 backdrop-blur-xl border-slate-800/50 shadow-2xl p-8">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-white mb-2 animate-in fade-in slide-in-from-top-2 duration-500 delay-100">
              {title}
            </h1>
            <p className="text-slate-400 text-sm animate-in fade-in duration-500 delay-200">{subtitle}</p>
          </div>
          {children}
        </Card>
      </div>
