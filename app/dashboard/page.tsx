            ...
            <Card className="bg-slate-900/50 backdrop-blur-xl border-slate-800/50 shadow-2xl p-8 mb-6">
              <div className="flex items-center gap-6">
                <img
                  ...
                  className="w-24 h-24 rounded-full border-4 border-indigo-500/30 object-cover shadow-lg animate-in zoom-in duration-500 delay-200"
                  onError={(e) => {
                    e.currentTarget.src = `https://api.dicebear.com/8.x/initials/png?seed=${userData.displayName}`
                  }}
                />
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-white mb-1 animate-in fade-in slide-in-from-left-4 duration-500 delay-300">
                    {t.welcome}, {userData.displayName}!
                  </h2>
                  <p className="text-slate-400 animate-in fade-in slide-in-from-left-4 duration-500 delay-400">
                    {userData.email}
                  </p>
                </div>
              </div>
